...
set collections from the \href{http://software.broadinstitute.org/gsea/msigdb/collections.jsp}{Molecular Signatures Database (MSigDB)}.
Analogously, \Rfunction{getGenesets} with \Rcode{db = "enrichr"} allows to obtain
gene set libraries from the comprehensive \href{https://amp.pharm.mssm.edu/Enrichr/#stats}{Enrichr collection}.
...
corresponding $p$-value. The \Rfunction{gsRanking} function displays only those
